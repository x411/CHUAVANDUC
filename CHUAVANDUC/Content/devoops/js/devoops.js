...
function SessionEnd() {
    ...
    //LoadAjaxContent('/Login/Index', 'ajax-content');
}

//
// Loading Animation
//
function showLoadingAnimation(id) {
    var htm = '<div id="loader-wrapper"><div id="loader"></div></div>';
...
function hideLoadingAnimation(duration) {
    $('#loader-wrapper').fadeOut(duration, function () {
