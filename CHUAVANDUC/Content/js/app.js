...
function initPjax() {
    var a = function () {
        this.pjaxEnabled = window.PJAX_ENABLED, this.debug = window.DEBUG, this.$sidebar = $("#sidebar"), this.$content = $(".content"), this.$loaderWrap = $(".loader-wrap"), this.pageLoadCallbacks = {}, this.loading = !1, this._resetResizeCallbacks(), this._initOnResizeCallbacks(), this.pjaxEnabled && (this.$sidebar.find("a:not(.accordion-toggle):not([data-no-pjax])").on("click", $.proxy(this._checkLoading, this)), $(document).pjax("#sidebar a:not(.accordion-toggle):not([data-no-pjax])", ".content", {
            fragment: ".content",
            type: "GET",
            timeout: 1e4
    ...
    a.prototype._initOnResizeCallbacks = function () {
        ...
        this.$sidebar.find("li.active").removeClass("active"), this.$sidebar.find('a[href*="' + this.extractPageName(c.url) + '"]').each(function () {
        ...
        this.showLoaderTimeout = setTimeout(function () {
            a.$content.addClass("hiding"), a.$loaderWrap.removeClass("hide"), setTimeout(function () {
        ...
        this.$loaderWrap.one($.support.transition.end, function () {
            a.$loaderWrap.addClass("hide"), a.$content.removeClass("hiding")
        ...
        g.each(function () {
            ...
            if (!b.length) {
                var c = document.createElement("script");
                c.src = $(this).attr("src"), k.load(function () {
        ...
        var b = this.loading;
        return this.loading = !0, b ? (this.log("attempt to load page while already loading; preventing."), a.preventDefault()) : this.log(a.currentTarget.href + " loading started."), !b
...
chartsOff && (nv.addGraph = function () { }), COLOR_VALUES = [$red, $orange, $green, $blue, $teal, $redDark], window.colors = function () {
    ...
    }), initPjax(), initDemoFunctions(), initAppPlugins()
});